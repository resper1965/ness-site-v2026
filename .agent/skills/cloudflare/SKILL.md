...
```
Need to run code?
├─ Serverless functions at the edge → workers/ (Ideal for ness-site2026 Hono backend)
├─ Full-stack web app with Git deploys → pages/ (Ideal for ness-site2026 React Router SSR)
