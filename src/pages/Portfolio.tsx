                        ...
                        <div className="aspect-video bg-surface-container-low overflow-hidden relative flex items-center justify-center">
                          ...
                          {highlightStat && (
                            <div className="absolute top-6 right-6">
                              <div className="px-4 py-2 rounded-full bg-primary-container/20 border border-primary-container/30 backdrop-blur-md flex items-center justify-center gap-2 text-[11px] text-primary-container font-medium uppercase tracking-widest">
                          ...
                          {highlightStat && (
                            <div className="absolute top-6 right-6">
                              <div className="px-4 py-2 rounded-full bg-primary-container/20 border border-primary-container/30 backdrop-blur-md">
                                <span className="text-[11px] text-primary-container font-medium uppercase tracking-widest">{highlightStat}</span>
                              </div>
                            </div>
                          )}
                        </div>
