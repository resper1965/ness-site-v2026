  ...
  return (
    <div className="relative flex items-start gap-3 py-2">
      <input
        ...
        className="peer mt-px h-6 w-6 shrink-0 cursor-pointer appearance-none rounded-md border border-white/20 bg-white/5 transition-colors checked:border-primary-container checked:bg-primary-container hover:border-white/40 checked:hover:border-primary-container focus-visible:ring-2 focus-visible:ring-primary-container focus-visible:ring-offset-2 focus-visible:ring-offset-surface-container-low"
      />
      ...
      <svg
        aria-hidden="true"
        viewBox="0 0 20 20"
        className="pointer-events-none absolute left-0 top-2 mt-px h-6 w-6 opacity-0 peer-checked:opacity-100"
      >
