...
| [`docs/PLAN-movimento.md`](docs/PLAN-movimento.md) | **Plano de movimento** — a camada de animação sobre o desenho delicado (aprovado em 12/09; M1–M4 no PR #49) |
| [`docs/ESTUDO-desktop-wow.md`](docs/ESTUDO-desktop-wow.md) | **Estudo Tailwind/shadcn e o desktop** — por que o desktop parece tímido e o plano de composição (12/09; C1–C4 no PR #49) |
