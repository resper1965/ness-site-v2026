...
-- PT
('pt', 'resiliencia-cibernetica-2026',
  'A Nova Era da Resiliência Cibernética', 'Segurança', 'ShieldCheck',
  '2026-04-12',
  'Como as empresas estão se preparando para ameaças invisíveis em 2026.',
  1, 1),

('pt', 'ia-generativa-operacoes-criticas',
  'IA Generativa em Operações Críticas', 'IA', 'Brain',
  '2026-04-10',
  'O papel dos agentes autônomos na eficiência operacional moderna.',
  1, 0),

('pt', 'arquiteturas-serverless-escalabilidade',
  'Arquiteturas Serverless e Escalabilidade', 'Cloud', 'Cloud',
  '2026-04-08',
  'Maximizando a performance com infraestrutura sob demanda.',
  1, 0),

-- EN
('en', 'cyber-resilience-2026',
  'The New Era of Cyber Resilience', 'Security', 'ShieldCheck',
  '2026-04-12',
  'How companies are preparing for invisible threats in 2026.',
  1, 1),

('en', 'generative-ai-critical-operations',
  'Generative AI in Critical Operations', 'AI', 'Brain',
  '2026-04-10',
  'The role of autonomous agents in modern operational efficiency.',
  1, 0),

('en', 'serverless-architectures-scalability',
  'Serverless Architectures and Scalability', 'Cloud', 'Cloud',
  '2026-04-08',
  'Maximizing performance with on-demand infrastructure.',
  1, 0),

-- ES
('es', 'resiliencia-cibernetica-2026',
  'La Nueva Era de la Resiliencia Cibernética', 'Seguridad', 'ShieldCheck',
  '2026-04-12',
  'Cómo las empresas se preparan para amenazas invisibles en 2026.',
  1, 1),

('es', 'ia-generativa-operaciones-criticas',
  'IA Generativa en Operaciones Críticas', 'IA', 'Brain',
  '2026-04-10',
  'El papel de los agentes autónomos en la eficiencia operacional moderna.',
  1, 0),

('es', 'arquitecturas-serverless-escalabilidad',
  'Arquitecturas Serverless y Escalabilidad', 'Cloud', 'Cloud',
  '2026-04-08',
...
('pt',
  'Analista de Segurança Ofensiva (Red Team)',
  'segurança',
  'Remoto / Portugal',
  'Full-time',
...
('en',
  'Offensive Security Analyst (Red Team)',
  'security',
  'Remote / Portugal',
  'Full-time',
...
('es',
  'Analista de Seguridad Ofensiva (Red Team)',
  'seguridad',
  'Remoto / Portugal',
  'Full-time',
...
INSERT INTO cases (lang, client, category, project, result, desc, stats, image, featured, published) VALUES
