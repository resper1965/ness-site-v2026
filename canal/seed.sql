...
-- PT
('pt', 'segurança',
  'resiliencia-cibernetica-2026', 'A Nova Era da Resiliência Cibernética',
...
('pt', 'ia',
  'ia-generativa-operacoes-criticas', 'IA Generativa em Operações Críticas',
  'IA', 'Brain',
  '2026-04-10',
...
('pt', 'cloud',
  'arquiteturas-serverless-escalabilidade', 'Arquiteturas Serverless e Escalabilidade',
  'Cloud', 'Cloud',
  '2026-04-08',
...
-- EN
('en', 'security',
  'cyber-resilience-2026', 'The New Era of Cyber Resilience',
...
('en', 'ai',
  'generative-ai-critical-operations', 'Generative AI in Critical Operations',
  'AI', 'Brain',
  '2026-04-10',
...
('en', 'cloud',
  'serverless-architectures-scalability', 'Serverless Architectures and Scalability',
  'Cloud', 'Cloud',
  '2026-04-08',
...
-- ES
('es', 'seguridad',
  'resiliencia-cibernetica-2026', 'La Nueva Era de la Resiliencia Cibernética',
...
('es', 'ia',
  'ia-generativa-operaciones-criticas', 'IA Generativa en Operaciones Críticas',
  'IA', 'Brain',
  '2026-04-10',
...
('es', 'cloud',
  'arquitecturas-serverless-escalabilidad', 'Arquitecturas Serverless y Escalabilidad',
  'Cloud', 'Cloud',
  '2026-04-08',
...
-- PT
('pt', 'remoto-/-são-paulo',
  'Engenheiro de Software Sênior (Fullstack)', 'engenharia',
  'Remoto / São Paulo',
  'Full-time',
...
('pt', 'remoto-/-portugal',
  'Analista de Segurança Ofensiva (Red Team)', 'segurança',
  'Remoto / Portugal',
  'Full-time',
...
('pt', 'híbrido-/-chile',
  'Arquiteto de Soluções Cloud', 'infraestrutura',
  'Híbrido / Chile',
  'Full-time',
...
-- EN
('en', 'remote-/-são-paulo',
  'Senior Software Engineer (Fullstack)', 'engineering',
  'Remote / São Paulo',
  'Full-time',
...
('en', 'remote-/-portugal',
  'Offensive Security Analyst (Red Team)', 'security',
  'Remote / Portugal',
  'Full-time',
...
-- ES
('es', 'remoto-/-são-paulo',
  'Ingeniero de Software Senior (Fullstack)', 'ingeniería',
  'Remoto / São Paulo',
  'Full-time',
...
('es', 'remoto-/-portugal',
  'Analista de Seguridad Ofensiva (Red Team)', 'seguridad',
  'Remoto / Portugal',
  'Full-time',
...
('es', 'híbrido-/-chile',
  'Arquitecto de Soluciones Cloud', 'infraestructura',
  'Híbrido / Chile',
  'Full-time',
...
-- PT
('pt', 'resposta-a-ransomware-global',
  'Grupo Industrial Global', 'segurança',
...
('pt', 'gabios---copiloto-logístico',
  'Varejo de Larga Escala', 'ia',
...
('pt', 'escala-black-friday',
  'E-commerce Unicórnio', 'infraestrutura',
  'Escala Black Friday',
...
('pt', 'vazamento-de-dados-críticos',
  'Instituição Financeira', 'segurança',
...
('pt', 'orquestração-híbrida',
  'Logística Integrada', 'infraestrutura',
...
-- EN
('en', 'global-ransomware-response',
  'Global Industrial Group', 'security',
...
('en', 'gabios---logistics-copilot',
  'Large-Scale Retail', 'ai',
...
('en', 'black-friday-scale',
  'Unicorn E-commerce', 'infrastructure',
  'Black Friday Scale',
...
-- ES
('es', 'respuesta-a-ransomware-global',
  'Grupo Industrial Global', 'seguridad',
...
('es', 'gabios---copiloto-logístico',
  'Comercio Minorista a Gran Escala', 'ia',
  'Gabi.OS - Copiloto Logístico',
...
('es', 'escala-black-friday',
  'E-commerce Unicornio', 'infraestructura',
  'Escala Black Friday',
...
('es', 'filtración-de-datos-críticos',
  'Institución Financiera', 'seguridad',
...
('es', 'orquestación-híbrida',
  'Logística Integrada', 'infraestructura',
