            ...
            <table className="w-full text-left border-collapse whitespace-nowrap">
              <thead>
                <tr className="bg-muted/30 border-b border-border/60">
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 pl-8 pr-4">Incidente</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Severidade</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Status</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">SLA (T-Limit)</th>
