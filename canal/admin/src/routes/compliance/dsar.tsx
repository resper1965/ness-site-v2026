            ...
            <table className="w-full text-left border-collapse whitespace-nowrap">
              <thead>
                <tr className="bg-muted/30 border-b border-border/60">
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 pl-8 pr-4">Solicitante</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Email</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Tipo</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Status</th>
                  <th className="py-4 font-bold text-[11px] uppercase tracking-widest text-muted-foreground/80 px-4">Deadline</th>
              ...
              <tbody className="divide-y divide-border/40">
                {items.map((item) => (
                  <tr key={item.id} className="group hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-150">
                    <td className="py-5 pl-8 pr-4 text-[14px] font-bold text-foreground">
                      {item.requester_name}
                    </td>
                    <td className="py-5 px-4 text-[14px] font-medium text-muted-foreground">
